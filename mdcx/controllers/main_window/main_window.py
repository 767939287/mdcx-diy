...
{sites_html}  <p><span style=" font-weight:700;">指定类型影片可指定刮削网站:<span></p>
  <p>· 有码：dmm、dmm_api、libredmm、r18dev、avbase、faleno、giga、dahlia、xcity、prestige、mgstage、fantastica、cableav、getchu、getchu_dmm、javlibrary、jav321、freejavbt、lulubar、avmoo，以及 javbus、javdb 系、missav 系、official、7mmtv、airav_cc、avsex、javday、iqqtv 等综合站；dmm_api/thejavdb_api/missav_api/r18dev 是免 CF 通道</p>
