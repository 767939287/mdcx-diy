...
{sites_html}  <p><span style=" font-weight:700;">指定类型影片可指定刮削网站:<span></p>
  <p>· 有码：dmm、dmm_api、libredmm、r18dev、avbase、faleno、giga、dahlia、xcity、prestige、mgstage、fantastica、cableav、getchu、getchu_dmm、javlibrary、jav321、freejavbt、lulubar、avmoo，以及 javbus、javdb 系、missav 系、official、mmtv、airav_cc、avsex、javday、iqqtv 等综合站；javdb_api/missav_api/r18dev 是免墙通道</p>
