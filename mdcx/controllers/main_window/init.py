...
def Init_Singal(self: "MyMAinWindow"):
    ...
    self.Ui.pushButton_emby_actor_manager.clicked.connect(self.pushButton_emby_actor_manager_clicked)
    ...
    self.pushButton_emby_actor_manager.connect(self.Ui.pushButton_emby_actor_manager.setText)
