...
class ConfigV1:
    ...
    website_youma: str = r"airav_cc,iqqtv,javbus,freejavbt,dmm,javlibrary,7mmtv,javdb,avsex,avmoo,lulubar,xcity,avsox"

    website_wuma: str = r"iqqtv,javbus,freejavbt,avsox,7mmtv,javdb"
    website_suren: str = r"mgstage,avsex,freejavbt,7mmtv,javbus,javdb"
    ...
    director_website_exclude: str = r"airav_cc,avsex,avsox,fc2,fc2hub,iqqtv,mgstage,lulubar"
