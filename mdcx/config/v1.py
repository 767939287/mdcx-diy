...
class ConfigV1:
    ...
    website_fc2: str = r"fc2,fc2club,fc2hub,freejavbt,javdb,avsox"
    ...
    poster_website_exclude: str = r"fc2club,fc2hub,iqqtv,javlibrary,lulubar"
    ...
    score_website_exclude: str = r"airav_cc,avsex,avsox,fc2,fc2hub,iqqtv,javbus,xcity,lulubar"
